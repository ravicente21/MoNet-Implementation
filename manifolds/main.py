...
'This transforms the data using the node features and graph structure. It uses 3D coordinates as features and build edges based on Face information'
...
'Splits the FAUST dataset into training and testing.'
...
'This constructs a MoNet model with 3 GMM convolutional layers and 2 linear layers.'
