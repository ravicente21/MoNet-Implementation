...
'This function is used to run both the training and testing of the model'
...
'The function trains by computing the negative log-likelihood loss and updates the weights'
...
'The function  tests the model by outputting the accuracy and the loss'
